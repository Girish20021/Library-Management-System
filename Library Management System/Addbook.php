    ...
    <div class="full-page1">
        ...
        <div id='issue-form' class='issue-page'>
            <div class="form-box">
                ...
                <form id='login' class='input-login' method='POST'action='add.php'>
...
<input type='text' class='input-field' placeholder='&#xf02d; Genre' name='genre' required><br><br>
<input type='text' class='input-field' placeholder='&#xf02d; No Of Books' name='qunatity' required><br><br>
                    <input type="submit" value="&#xf2b5; ADD" name="submitbook"class="submit-btn"/>
                </form>
            </div>
        </div>
    </div>
