    ...
    <div class="full-page1">
        ...
        <div id='issue-form' class='issue-page'>
            <div class="form-box">
                ...
                <form id='login' class='input-login' method='POST'action='create.php'>
                    ...
                    <input class="input-field" type="date" placeholder="date"name="doj" required>
                    <input type="submit" value="&#xf2b5; Create" name="submitadmin" class="submit-btn"/>
                </form>
            </div>
        </div>
    </div>
